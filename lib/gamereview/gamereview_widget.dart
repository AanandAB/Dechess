...
import 'gamereview_model.dart';
export 'gamereview_model.dart';

class GamereviewWidget extends StatefulWidget {
  const GamereviewWidget({Key? key}) : super(key: key);

  @override
  _GamereviewWidgetState createState() => _GamereviewWidgetState();
}

class _GamereviewWidgetState extends State<GamereviewWidget> {
  late GamereviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GamereviewModel());
  }
